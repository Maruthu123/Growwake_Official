...
export default function Navbar() {
  ...
  const [submenuOpen, setSubmenuOpen] = useState(false); // "services" | "courses"
    ...
    <>
      ...
      <nav className={`navbar ${scrolling ? "scrolled" : ""}`}>
        <div className="logo_container">
          <img src="/bluegrowwake.png" width="150" alt="logo" />
        </div>
        ...
        {/* DESKTOP BUTTONS */}
        <div className="buttons desktop_only">
          <button className="button_text"><Link to="/register">Register</Link></button>
        </div>
